  ...
  <tbody>
      <?php foreach ($societe as $key => $value) : ?>
        <tr>
          ...
          <td>
          <input type="text" name="<?php echo $key; ?>" id="<?php echo $key; ?>" value="<?php echo htmlspecialchars($value); ?>" <?php echo ($key === 'societe_id' ? 'readonly' : null)?> <?php echo ($key === 'societe_type' ? 'readonly' : null)?> >
          </td>
