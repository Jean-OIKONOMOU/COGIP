...
<table class="table">
    ...
    <tr>
      ...
      <?php foreach ($result as $row) { ?>
          <tr>
    <td><?php echo escape($row["people_id"]); ?></td>
    <td><?php echo escape($row["people_prenom"]); ?></td>
    <td><?php echo escape($row["people_nom"]); ?></td>
    <td><?php echo escape($row["people_phone"]); ?></td>
    <td><?php echo escape($row["people_email"]); ?></td>
    <td><?php echo escape($row["societe_societe_id"]); ?></td>
          </tr>
        <?php } ?>
          </tbody>
      </table>
