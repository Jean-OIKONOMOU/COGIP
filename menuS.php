...
<div class="table-responsive">
    ...
    <thead>
        ...
        <tbody>
            ...
            <tr>
                <td><a title="Voir les informations" href="singleSoc.php?id=<?php echo htmlspecialchars($row["societe_id"]); ?>"><?php echo htmlspecialchars($row["societe_nom"]);?></a></td>
                <td><a title="Cliquez pour modifier" href="editS.php?id=<?php echo htmlspecialchars($row["societe_id"]); ?>">
                        <i class="fas fa-pen text-right"></i></a></td>
                <td><a title="Cliquez pour supprimer" href="deleteS.php?id=<?php echo htmlspecialchars($row["societe_id"]); ?>"><i
