  ...
  <tbody>
      <?php foreach ($user as $key => $value) : ?>
        <tr>
          ...
          <td>
          <input type="text" name="<?php echo $key; ?>" id="<?php echo $key; ?>" value="<?php echo escape($value); ?>" <?php echo ($key === 'people_id' ? 'readonly' : null)?> <?php echo ($key === 'societe_societe_id' ? 'readonly' : null)?> >
          </td>
